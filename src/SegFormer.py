...
if __name__ == "__main__":
    ...
    # RESUME_CKPT_PATH = "/home/cbm/deRFI/checkpoints/train/best_model-epoch=04-fgmIoU_val_fg_miou=0.4717.ckpt"
    RESUME_CKPT_PATH = "/home/cbm/deRFI/checkpoints/train/best_model-epoch=09-fgF1_val_fg_macro_f1=0.7595.ckpt"
    # 预训练权重路径 (None表示随机初始化)
    ...
    trainer.fit(
        ...
        ckpt_path=RESUME_CKPT_PATH if os.path.exists(RESUME_CKPT_PATH) else None, # 彻底从零开始重新训练
    )
