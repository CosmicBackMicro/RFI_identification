...
class UNetLightningModule(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        # 保存到本地文件，方便直接查看
        save_path = f"results/inference_plots/val_cm_epoch_{self.current_epoch}.png"
...
if __name__ == "__main__":
    ...
    RESUME_CKPT_PATH = "/home/cbm/deRFI/checkpoints/train/best_model-epoch=16-fgmIoU_val_fg_miou=0.7214.ckpt"
    # 预训练权重路径 (None表示随机初始化)
